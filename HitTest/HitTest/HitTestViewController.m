...
//默认
//gesture2.delaysTouchesBegan = NO;
//gesture2.cancelsTouchesInView = YES;
//11 -[TestView touchesBegan:withEvent:]1
//11 -[TestView touchesBegan:withEvent:]2
//tapGesture :11
//11 -[TestView touchesCancelled:withEvent:]1
//11 -[TestView touchesCancelled:withEvent:]2

//gesture2.delaysTouchesBegan = NO;
//gesture2.cancelsTouchesInView = NO;
//11 -[TestView touchesBegan:withEvent:]1
//11 -[TestView touchesBegan:withEvent:]2
//tapGesture :11
//11 -[TestView touchesEnded:withEvent:]1
//btnClick :11
//11 -[TestView touchesEnded:withEvent:]2

//gesture2.delaysTouchesBegan = YES;
//gesture2.cancelsTouchesInView = NO;
//tapGesture :11
//11 -[TestView touchesEnded:withEvent:]1
//11 -[TestView touchesEnded:withEvent:]2
...
- (void)tapGesture:(UITapGestureRecognizer *)recognizer{
    ...
    NSLog(@"%2@ ExtraTapGesture",@(recognizer.view.tag));
}
